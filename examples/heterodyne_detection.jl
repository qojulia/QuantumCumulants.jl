...
eqs = meanfield(ops, H, J; rates = rates, order = 2) # test # TODO
...
plot(sol_det.t .* 1000, real(sol_det[a'a]), 
    xlabel = "Time (ms)", ylabel = "Cavity photon number", xlims = (0, 0.1), legend = false)
