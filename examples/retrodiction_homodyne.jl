...
pp = plot(sol_fw.t * Γ_, real(sol_fw[x]), 
    xlabel = "Γt", ylabel = "⟨x⟩", legend = false)
...
p1 = plot(t_W*Γ_, x_fw; size = (500, 250), label = "",
    xlabel = "Γt", ylabel = "⟨x⟩", ylim = (-10, 10), grid = true)
...
p2 = plot(t_W*Γ_, x_bw; size = (500, 250), label = "",
    xlabel = "Γt", ylabel = "⟨x⟩", ylim = (-10, 10), grid = true)
...
p3 = plot(t_W*Γ_, x_pq; size = (500, 250), label = "",
    xlabel = "Γt", ylabel = "⟨x⟩", ylim = (-10, 10), grid = true)
