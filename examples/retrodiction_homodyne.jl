...
pp = plot(sol_fw.t * Γ_, real(get_solution(sol_fw, x, eqs)(sol_fw.t)), xlabel = "Γt", ylabel = "⟨x⟩", legend = false)
...
eqs_back_kal = meanfield(ops, -H, J; rates = R, order = 2, direction = Backward())
...
sys_back_kal = mtkcompile(System(eqs_back_kal_c2; name = :sys_back_kal))
