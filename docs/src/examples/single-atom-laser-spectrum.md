...
he_n = meanfield(a'*a,H,J;rates=rates,order=2)
nothing # hide
```
...
# Complete equations
me = complete(he_n;filter_func=phase_invariant)
```
...
c = CorrelationFunction(a', a, me; steady_state=true, filter_func=phase_invariant)
nothing # hide
```
