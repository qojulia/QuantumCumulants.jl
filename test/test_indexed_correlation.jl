...
@testset "indexed_correlation" begin
    ...
    it_ = findfirst(
        x->typeof(arguments(x)[2]) == SymbolicUtils.BasicSymbolic{IndexedAverageSum},
        args_,
    )
    ...
    corr = IndexedCorrelationFunction(
        a',
        a,
        eqs_c;
        steady_state = true,
    ...
    corr_nss = IndexedCorrelationFunction(
        a',
        a,
        eqs_c;
        steady_state = false,
