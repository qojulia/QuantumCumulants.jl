...
@test iszero(simplify_operators(he_laser.rhs[1] - ((-κ)*a'*a + (-1.0im*g)*a'*σ + (1.0im*g)*a*σ')))
@test iszero(simplify_operators(he_laser.rhs[2] - (ν + (-ν - γ)*σee + (1.0im*g)*a'*σ + (-1.0im*g)*a*σ')))
